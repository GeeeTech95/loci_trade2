...
class Register(CreateView) :
    ...
    def get(self,request,*args,**kwargs) :
        ...
        if 'reg_id' in request.GET : 
            ...
            try : 
                reg_id = int(reg_id)  #cleaning
                initials['registration_id'] = reg_id
            except : 
    ...
    def post(self,request,*args,**kwargs) :
        ...
        if form.is_valid() :
            ...
            #add admin and notify
            reg_id = form.cleaned_data.get('registration_id',my_reg_id)
            try : 
                admin = MyAdmin.objects.get(reg_id = reg_id)
                form.instance.admin = admin.user
